...
function intro() {prompt('Hello there ' + userName + '. My name is Andy Helmer. Would you like to play a guessing game about me? Please answer with yes or no if asked.Your answer will be assumed as a no if you type anything else.(yes or no)').toLowerCase();
  if (intro === 'yes') {
    correct();
  } else {
    incorrect();
...
function amIAPro(){ prompt('Am I the best coder in the world ' + userName + '? (yes or no)').toLowerCase();
  if (amIAPro === 'yes') {
